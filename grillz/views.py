...
def shop(request):
    return render(request, 'grillz/shop.html')

def product_list(request):
    products = Product.objects.all()
    return render(request, 'grillz/product_list.html', {'products': products})
...
def cart_detail(request):
    ...
    return render(request, 'grillz/cart_detail.html', {'cart': cart})
...
def add_product(request):
    if request.method == 'POST':
        ...
        form = ProductForm()
    return render(request, 'grillz/add_product.html', {'form': form})
...
def signup(request):
    if request.method == 'POST':
        ...
        form = SignUpForm()
    return render(request, 'grillz/signup.html', {'form': form})
